...
Gem::Specification.new do |spec|
  spec.name        = 'effective_work_experience'
  spec.version     = EffectiveWorkExperience::VERSION
  spec.authors     = ['Code and Effect']
  spec.email       = ['info@codeandeffect.com']
  spec.homepage    = 'https://github.com/code-and-effect/effective_work_experience'
  spec.summary     = 'Interns record their work experience hours and projects, and mentors review them'
  spec.description = 'Interns record their work experience hours and projects, and mentors review them'
  spec.license     = 'MIT'
  ...
  spec.add_development_dependency 'effective_email_templates'
